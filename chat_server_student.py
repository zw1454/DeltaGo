...
#==============================================================================
            if code == M_CONNECT:
                ...
                # connect to the peer
                    ...
                    ################################
                    Server.color[from_name] = 'blue'
                    Server.color[to_name] = 'red'
...
#==============================================================================
                ...
                #M_POEM handler needs to use self.sonnet functions to work
...
#==============================================================================
                ...
                #M_TIME handler has to calc current date/time to send (use time module)
...
#==============================================================================
                ...
                #M_SEARCH handler needs to use self.indices search to work
                term = msg[1:]
                from_name = self.logged_sock2name[from_sock]
